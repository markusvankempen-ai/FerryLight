...
# FerryLightV2 Setup - Part 3: Services and Deployment (FIXED)
...
EOF
    ...
    # MQTT configuration script (FIXED - no nested here-documents)
...
# Main execution
main() {
    print_header "🚀 FerryLightV2 Setup - Part 3: Services and Deployment (FIXED)"
    echo "====================================================================="
    echo ""
